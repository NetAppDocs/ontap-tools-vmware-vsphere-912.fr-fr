...
** Les actions telles que Supprimer, Supprimer le stockage et Modifier les propriétés sont autorisées en tant que telles
Les actions ne nécessitent pas de communication ONTAP.
...
. Cliquez sur *Afficher le certificat* pour afficher les détails du certificat.
Cliquez sur *Oui* pour ajouter le système de stockage
