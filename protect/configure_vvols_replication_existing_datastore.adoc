...
* Lors de la configuration d'une machine virtuelle pour activer la réplication d'un datastore existant, assurez-vous de vérifier le volume FlexVol qui possède un vVols de configuration.
