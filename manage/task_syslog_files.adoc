...
Les outils ONTAP pour VMware vSphere 9.12 suppriment les 2.0 API syslog précédentes et contiennent les nouvelles API syslog 3.0 qui prennent en charge l'authentification mutuelle.
