...
+
Voir la link:..configure/task_configure_user_role_and_privileges.html["Configurez les rôles et privilèges utilisateur"]
 Dans la documentation _Outils ONTAP pour VMware vSphere_.
